	...
	constructor(x, y, spriteSheet) {
		...
		this.dialog = [
			...
			*/
            ...
            // Issue encountered: after surfacing and recieving your journal you will endlessly get it and not be able to get anything else. Reordering items to see if that can get around the issue. Will ask about later.
