	...
	constructor(x, y, spriteSheet) {
		...
		this.dialog = [
			...
			*/
			...
			/* 12 */ { item: 'backupTech', needsSurfaced: 'backupTech', npc: "(You recieved your ~non-functional~ backup tech)", next: 1 },
			...
			/* 14 */ { human: " *Takes the real log* ", item: 'realLog',  next: 1 },
			/* 15 */ { human: " *Takes the fake log* ", item: 'fakeLog', next: 1 },
