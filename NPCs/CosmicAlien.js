...
//Fully tested! Works pretty well. Just gotta figure out how to sink items :3

		this.dialog = [
			/* 0 */ { npc: "Hello, human. You are a human, correct?" },
			/* 1 */ { human: "Oh- uh, Yes? How did you know?" },
			/* 2 */ { npc: "I don't know much about your race. I would like to know more but it's hard to get information on isolated or uncontacted races." },
			...
			/* 6 */ { npc: "No, but if you do get a map, I'll mark it for you. It's hard to navigate around here" },
            ...
            /* 15 */ { needsCollected: 'fakeLog', npc: "Did you get the info?" },
            /* 16 */ { human: "*You give her the fake log*", remove:'fakeLog', next: 17},
...
/* Losing astronaut journal and gaining collectionJournal*/
			...
			/* 24 */ { npc: "Awesome! Here's the collection", item:'cJournal', remove:'astJournal', next: 19 }, 
